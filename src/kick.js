...
const removeAccountComment = (user) => {
    return `@${user} you are being removed from the <org name> organization due to inactivity.  If you still require access, please follow the steps outlined in your [Handbook](https://fake-github-pages-link.github.io/github-handbook/guides/onboarding/getting-access) or send an email to support@fake-co.com`;
}
